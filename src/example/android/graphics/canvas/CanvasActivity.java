	...
	private OnClickListener btnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case TAG_BLACK:
				...
				Toast.makeText(CanvasActivity.this, "筆色を黒に変更", Toast.LENGTH_SHORT).show();
				break;
			case TAG_RED:
				view.changeColor(TAG_RED);
				Toast.makeText(CanvasActivity.this, "筆色を赤に変更", Toast.LENGTH_SHORT).show();
				break;
			case TAG_GREEN:
				view.changeColor(TAG_GREEN);
				Toast.makeText(CanvasActivity.this, "筆色を緑に変更", Toast.LENGTH_SHORT).show();
				break;
			case TAG_BLUE:
				view.changeColor(TAG_BLUE);
				Toast.makeText(CanvasActivity.this, "筆色を青に変更", Toast.LENGTH_SHORT).show();
				break;
			default:
				break;
			}
